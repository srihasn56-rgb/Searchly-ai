...
[![Release](https://img.shields.io/github/v/release/Srihass/Searchly-ai?style=flat-square&color=3b82f6)](https://github.com/Srihass/Searchly-ai/releases)
[![License](https://img.shields.io/badge/license-MIT-green?style=flat-square)](LICENSE.txt)
[![Platform](https://img.shields.io/badge/platform-Windows-lightgrey?style=flat-square)](https://github.com/Srihass/Searchly-ai/releases)
...
[⬇️ Download for Windows](https://github.com/Srihass/Searchly-ai/releases/tag/v1.0.0) · [Report a Bug](https://github.com/Srihass/Searchly-ai/issues)
...
- **Desktop Native** — Built with Electron
...
- [Searchly-AI-Setup-1.0.0.exe](https://github.com/Srihass/Searchly-ai/releases/tag/v1.0.0) — Full installer (recommended)
...
```bash
git clone https://github.com/Srihass/Searchly-ai.git
cd Searchly-ai
npm install
cp .env.example .env
...
Full [Privacy Policy](https://srihass.github.io/Searchly-ai/public/privacy.html).
